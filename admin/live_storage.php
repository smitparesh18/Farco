...
<style>
    ...
    /* ------------------------------------this code is only for image grid layout----------------------------------------------------- */
    .banner {
        background: #a770ef;
    ...
    /* ------------X------------------X----this code is only for image grid layout-------------------------X----------------X---------- */
</style>
          ...
          box-shadow: 0 8px 32px 0 rgba( 31, 38, 135, 0.37 );">
                    ...
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="POST">
                        <div class="input-group">
                            <input list="search_item" name="product_name" class="form-control border-0 small" placeholder="Search product here....." aria-label="Search" aria-describedby="basic-addon2" style="background: rgba( 255, 255, 255, 0.25 );
                box-shadow: 0 8px 32px 0 rgba( 31, 38, 135, 0.37 );
                backdrop-filter: blur( 4px );
                border: 1px solid rgba( 255, 255, 255, 0.18 );">
                            <datalist id="search_item" style="background-color: rgba( 255, 255, 255, 0.25 );">
                                <style>
                                    input[list] {
                    ...
                    <div class="px-lg-5">
                        ...
                        <div class="row py-5">
                            <div class="col-lg-12 mx-auto">
                                <div class="text-white p-5 shadow-sm rounded banner">
                                    <h1 class="display-4">Live Vegetable and Fruits Storage</h1>
                                </div>
                            </div>
                        </div>
                        <!-- End -->
                        <div class="row">
                            ...
                            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                ...
                                $sql = "SELECT * FROM `storage` WHERE `product_name`=' . $product . '";
                                $result = mysqli_query($conn, $sql);
                                while ($row = mysqli_fetch_assoc($result)) {
                                    $picture = $row['product_img'];

                                    echo '
                                <div class="col-xl-3 col-lg-4 col-md-6 mb-4" style="border:5px solid rgba(255,255,255,.1);background:rgba( 255, 255, 255, 0.1);backdrop-filter:blur(7px);">
                                <div class=" rounded shadow-sm">
                                    <center><img src="../fruits_and_vegetables/' . $picture . '" alt="" class="img-fluid card-img-top" style="border-radius: 50%;width:150px;height:150px;background:transparent;filter:drop-shadow(6px 126px  rgba(255,255,255,.1));"></center>
                                    <div class="p-4">
                                        <h5 class="text-center text-light"> <br>' . $row['product_name'] . '</h5>
                                        <p class="small text-muted mb-5"></p>

                                    </div>
                                    <div class="section" style="width: 100%;">
                                        <span style="color:white;width:48%;float:right;text-align:center;border-top-left-radius:5px;border-top-right-radius:5px;
                                       background-image: linear-gradient(120deg, #ff2452 0%, #ff8fa7 100%);
                                        box-shadow: 0 8px 32px 0 rgba( 31, 38, 135, 0.37 );
                                        backdrop-filter: blur( 4.0px );
                                        -webkit-backdrop-filter: blur( 4.0px );padding-top:5px;">
                                            <i class="fas fa-asterisk"></i> requirement<br>' . $row['current_stock'] . '
                                        </span><span style="color:white;float:left;width:48%;text-align:center;border-top-left-radius:5px;border-top-right-radius:5px;
                                        background-image: linear-gradient(to top, #9be15d 0%, #00e3ae 100%);
                                        box-shadow: 0 8px 32px 0 rgba( 31, 38, 135, 0.37 );
                                        backdrop-filter: blur( 4.0px );
                                        -webkit-backdrop-filter: blur( 4.0px );padding-top:5px;">
                                        <i class="fa fa-boxes"></i> available<br>' . $row['current_requirement'] . '</span>
                                    </div>
                                </div>
                            </div>
                            ';

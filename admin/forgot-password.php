...
if (isset($_POST['submit'])) {
    $email = $_POST['mail'];
    $sql = "SELECT *FROM `farco_admin` WHERE `email`='$email'";
    ...
    if ($row == 1) {
        while ($rows = mysqli_fetch_assoc($result)) {
            ...
            //     <p style="padding:5px;display:block;background:rgba(0,250,0,.7);color:black;">Click here to reset your password : http://farco.atwebpages.com/farco/admin/reset_password.php?token=' . $password . '</p>
            //     </body>
            // </html>';
...
<head>
    ...
    <title>FARCO ADMIN PANEL - Forgot Password</title>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4 text-gray-500">We get it, stuff happens. Just enter your email address below and we'll send your password!</p>
                                    </div>
                            ...
                            Sorry! Invalid email Address
                              ...
                              Success! we have been sent forgot password link on you gmail Account
                              </h6>';
                                            }
                                            ?>
                                            <input type="email" class="form-control form-control-user" name="mail" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address..." required>
                                        </div>
                                        <button type="submit" name="submit" class="btn btn-user btn-block" style="background-color: crimson;color:white;">Set your password</button>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="medium" href="register.php" style="color: #63ff23;font-weight:600;">Create an Account!</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="medium" href="login.php" style="color: coral;font-weight:600;">Already have an account? Login!</a>
                                    </div>
                                </div>
                            </div>
                        </div>

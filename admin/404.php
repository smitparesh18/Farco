          ...
          box-shadow: 0 8px 32px 0 rgba( 31, 38, 135, 0.37 );">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline  medium" style="font-family: 'Pacifico', cursive;color:rgba( 255, 255, 255, 0.55 );text-decoration:underline;">
                                    <?php echo $fname;
                                    echo " ";
                                    echo $lname; ?>
                                </span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        <div style="display:inline;font-size:3em;" class="error" data-text="Access_denied"> Access_denied</div>
                        <p class="lead text-gray-800 mb-5" style="font-weight:700">Page Not Found Or you don't have aceess for that page</p>
